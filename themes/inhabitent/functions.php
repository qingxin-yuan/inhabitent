...
function inhabitent_scripts() {
	...
	wp_enqueue_style('inhabitent-font-awesome','https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
	...
	wp_enqueue_script( 'menu-toggle', get_template_directory_uri() . '/build/js/menu.min.js', array('jquery'), null, true);
