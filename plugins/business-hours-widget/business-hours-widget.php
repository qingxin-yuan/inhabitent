 ...
 * @author    qingxin yuan <qingxin.yn@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2017 qingxin
 *
 * @wordpress-plugin
...
class Tent_Biz_Hours extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(	//inherent __construct from the parent class
	...
	public function widget( $args, $instance ) {
		...
		$widget_string .= ob_get_clean();//ob_get_clean() output whatever is in the buffer
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['title'] = strip_tags( $new_instance['title'] );//strip_tags() get rid of the HTML/PHP tags from a string
